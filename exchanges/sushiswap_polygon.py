...
("WETH", "DAI", "0x6FF62bfb8c12109E8000935A6De54daD83a4f39f"),
("WETH", "USDT", "0xc2755915a85C6f6c1C0F3a86ac8C058F11Caa9C9"),

# 0xBTC pairs
("WMATIC", "0xBTC", "0x7A744Cc8999f260A38e3be3A25009CDB36652Fcc"),
("0xBTC", "WETH", "0xBEF1666F1a3849bCc6B314F8eB83BA2e16DF38D6"),
...
class SushiSwapPolygonAPI(Daily24hChangeTrackedAPI):
    def __init__(self, currency_symbol, timeout=10.0):
        ...
        self.exchange_name = "SushiSwap Polygon"
...
if __name__ == "__main__":
    ...
    # get some data from 0xBTC pool via SushiSwapPolygonAPI
    e = SushiSwapPolygonAPI('0xBTC')
    ...
    # get some data from KIWI pool via SushiSwapPolygonAPI
    # e = SushiSwapPolygonAPI('KIWI')
    # e.load_once_and_print_values()
    # print()
    # try:
